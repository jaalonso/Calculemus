(* Si_a_es_un_punto_de_acumulacion_de_u,_entonces_forall_epsilon_gt_0,_forall_N,_exists_k_ge_N,_|u(k)-a|_lt_epsilon.thy
-- Si a es un punto de acumulación de u, entonces \<forall>\<epsilon>>0, \<forall> N, \<exists>k\<ge>N, |u(k)−a| < \<epsilon>
