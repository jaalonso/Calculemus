...
--   entonces el límite de (f \<circ> u) es f(a)"
...
--    definition continua_en_punto :: "(real \<Rightarrow> real) \<Rightarrow> real \<Rightarrow> bool" where
--      "continua_en_punto f a \<longleftrightarrow> 
