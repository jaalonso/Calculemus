...
+ 22-07-21: [[./textos/Las_funciones_crecientes_son_inyectivas.md][Si `f x ≤ f y → x ≤ y`, entonces f es inyectiva]] (En [[./src/Las_funciones_crecientes_son_inyectivas.lean][Lean]] y en [[./thy/Las_funciones_crecientes_son_inyectivas.thy][Isabelle]]).
